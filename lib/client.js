...
/*
  This file was modified to accept a request options object in the constructor, and to pass it down to the underlying request instance
*/
...
class Client {
  constructor(apiKey, baseUrl, requestOpts) {
    this.apiKey = apiKey;
  ...
  _wrap(options) {
    return new Promise((resolve, reject) => {
      request({ ...options, ...this.requestOpts }, (error, response, body) => {
        if (error) {
