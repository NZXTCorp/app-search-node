...
/*
  This file was modified to accept a request options object in the constructor
*/
...
class AppSearchClient {
  constructor(
    accountHostKey,
    apiKey,
    baseUrlFn = DEFAULT_BASE_URL_FN,
    requestOpts = {}
  ) {
    const baseUrl = baseUrlFn(accountHostKey);
    this.client = new Client(apiKey, baseUrl, requestOpts);
  }
  ...
  search(engineName, query, options = {}) {
    ...
    return this.client.get(
      `engines/${encodeURIComponent(engineName)}/search`,
      options
    );
  }
  ...
  multiSearch(engineName, searches) {
    ...
    return this.client.post(
      `engines/${encodeURIComponent(engineName)}/multi_search`,
      {
        queries: searches,
      }
    );
  ...
  querySuggestion(engineName, query, options = {}) {
    options = Object.assign({}, options, { query });
    return this.client.post(
      `engines/${encodeURIComponent(engineName)}/query_suggestion`,
      options
    );
  }
  ...
  indexDocument(engineName, document) {
    return this.indexDocuments(engineName, [document]).then(
      (processedDocumentResults) => {
  ...
  indexDocuments(engineName, documents) {
    return this.client.post(
      `engines/${encodeURIComponent(engineName)}/documents`,
      documents
    );
  }
  ...
  destroyDocuments(engineName, ids) {
    return this.client
      .delete(`engines/${encodeURIComponent(engineName)}/documents`, ids)
      .then((response) => {
  ...
  getCuration(engineName, curationId) {
    return this.client.get(
      `engines/${encodeURIComponent(engineName)}/curations/${encodeURIComponent(
        curationId
      )}`,
      {}
    );
  ...
  createCuration(engineName, newCuration) {
    return this.client.post(
      `engines/${encodeURIComponent(engineName)}/curations`,
      newCuration
    );
  }
